...
// struct EmbedTypeNameMacroInput {
//     prefix: LitStr,
//     ty: Ident,
//     suffix: LitStr,
// }

// impl Parse for EmbedTypeNameMacroInput {
...
// pub fn embed_type_name_core(input: TokenStream) -> TokenStream {

//     let input = parse2::<EmbedTypeNameMacroInput>(input).unwrap();
//     let prefix = input.prefix;
//     let ty = input.ty;
//     let suffix = input.suffix;

//     let type_name = quote! { std::any::type_name::<#ty>() };    

//     let expanded = quote! {
//         const VALUE: &str = concat!(#prefix, #type_name, #suffix);
//         VALUE
//     };
